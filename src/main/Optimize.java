...
/**
 * This class returns a probable number of minimum cashiers that has to be open
 * to not miss any customers. The class runs many simulations with different
 * numbers of open cashiers and different random seeds to find this probable
 * number.
 * 
...
public class Optimize {
	 ...
	 * @param maxAmountCustomers
	 *            Number of maximal customers allowed in the store at any time.
	 * @param lambda
	 *            Intensity of customer arrivals.
	 * @param PickMin
	 *            Minimum time it takes for customer to pick groceries.
	 * @param PickMax
	 *            Maximum time it takes for customer to pick groceries.
	 * @param payMin
	 *            Minimum time spent at the register.
	 * @param payMax
	...
	public Optimize(double stopTime, int maxAmountCustomers, double lambda, double PickMin, double PickMax,
		...
		// maxAmountCustomers, lambda, PickMin, PickMax, payMin, payMax));
	}
